...
export const POST: RequestHandler = async ({ request }) => {
    ...
    /*
    This Snippet is how do we connect to openAi to get the books as json in an array. but we have to pay for that !! 
    */
    ...
    //     ],
    // });
    // const bookArayString = response.choices[0].message.content?.replace(/```json | ```/g, "").trim();
    // const bookArray = JSON.parse(bookArayString || "");


    /*
        This array here is just for Simulation !
    */
    const bookArray = [
